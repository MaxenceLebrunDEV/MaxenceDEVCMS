...
?>
    ...
    $stmt->setFetchMode(PDO::FETCH_ASSOC);
          ...
          while ($data=$stmt->fetch(PDO::FETCH_ORI_NEXT)) { 
            ...
            <form action="profil/modifierleprofil.php" method="post">
...
<legend class="uk-legend">Nom d'utilisateur:</legend>
	<input class="uk-input" type="text" name="username" value="<?php echo $data['username']; ?>" placeholder="Nom d'utilisateur:">
</div>

<div class="uk-margin">
	
<legend class="uk-legend">Jobs:</legend>

<input class="uk-input" type="text" name="jobs" value="<?php echo $data['jobs']; ?>" placeholder="Métier:">
</div>

<div class="uk-margin">
	
<legend class="uk-legend">Téléphone:</legend>
	<input class="uk-input" type="text" name="tel" value="<?php echo $data['tel']; ?>" placeholder="Téléphone:">
</div>

<div class="uk-margin">
	
<legend class="uk-legend">Image de profil:</legend>
...
<button type="submit" class="uk-button uk-button-default"> Modifier le profil</button>
            
    <a class="uk-button uk-button-default" href="../dashboard.php">Retour</a>
	<?php } ?>
