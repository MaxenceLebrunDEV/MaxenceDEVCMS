...
?>
	...
	<h3>Pour ajouter un utilisateur voici votre bouton:</h3><a href="addauser.php"><button type="button" class="uk-button uk-button-default"> Ajouter un utilisateur</button></a>
    <thead>
        <tr>
		<th>ID</th>
          <th>Nom</th>
