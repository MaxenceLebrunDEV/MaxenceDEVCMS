...
?>
  ...
  $query = "SELECT * FROM tb_produit WHERE name LIKE :search";
...
$stmt->setFetchMode(PDO::FETCH_ASSOC);
      ...
      while ($data=$stmt->fetch(PDO::FETCH_ORI_NEXT)) { 
		...
		<div class="uk-container">
          ...
          <td><a href="modifierunproduit.php?id=<?php echo $data['id']; ?>"><button type="button" class="uk-button uk-button-default"><i class="fa fa-pen"></i> Modifier</button></a><br><hr class="uk-divider"></td>
		  </tr>
		  </div>
        <?php } ?>
      </tbody>
